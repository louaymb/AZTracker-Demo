...
import { buildResearchFixture } from "./generators";
...
export async function generateInterviewPrep(): Promise<InterviewPrep> {
  // Interview-Vorbereitung ist im Demo-Modus bewusst nicht verfügbar.
  throw new Error("Im Demo-Modus nicht verfügbar.");
}
